...
As before the code will produce a PDF of the bar plot (`diff_exp_barplot.pdf`) in the workshop base directory. You can use MobaXTerm to transfer the file to your local machine and view it. We can see that in samples 1-5 and 11-15 (the 0hr timepoint samples) there are high CPM values indicating high expression and very little expression in samples 6-10 and 16-20 (the 1hr timepoint samples). This confirms our result of significant down-regulation for `CNB3_005342` at 1hr post infection.
